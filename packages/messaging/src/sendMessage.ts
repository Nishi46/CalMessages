import { createMessageEvent, getUserById, updateMessageEventTwilioSid, type MessageEvent } from '@tally/db-consumer';
...
export async function sendMessage(
  ...
  return updateMessageEventTwilioSid(event.id, sid);
}
